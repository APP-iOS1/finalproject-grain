...
enum GeocodeRouter {
    ...
    func asURLRequest(requestAddress: String) throws -> URLRequest {
        ...
        request.setValue(GeocodeEnum.geocode.clientID, forHTTPHeaderField: GeocodeEnum.geocode.clientHeaderKeyID)
        request.setValue(GeocodeEnum.geocode.clientSecret, forHTTPHeaderField: GeocodeEnum.geocode.clientHeaderSecretID)
