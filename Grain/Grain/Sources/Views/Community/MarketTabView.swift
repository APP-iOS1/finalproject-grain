        ...
        VStack{
            ScrollViewReader { proxyReader in
                ScrollView(showsIndicators: false){
                    VStack {
                        ForEach(communityVM.returnCategoryCommunity(category: "클래스", blockingUsers: userVM.blockingList, blockedUsers: userVM.blockedList), id: \.self){ data in
                            NavigationLink {
                        ...
                        .emptyPlaceholder(communityVM.returnCategoryCommunity(category: "클래스", blockingUsers: userVM.blockingList, blockedUsers: userVM.blockedList)) {
